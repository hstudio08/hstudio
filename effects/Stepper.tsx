...
export default function Stepper({
  ...
  disableStepIndicators = true, // Forced true for forms so users can't skip validation
}: StepperProps) {
    ...
    >
      <motion.div
        variants={{
          ...
          active: { scale: 1.1, backgroundColor: '#2563eb', color: '#fff' }, // Qurevo Blue
          complete: { scale: 1, backgroundColor: '#0ea5e9', color: '#fff' }  // Qurevo Sky
        }}
  ...
  return (
    <div className="step-connector">
      <motion.div
        ...
        variants={{ incomplete: { width: 0, backgroundColor: 'transparent' }, complete: { width: '100%', backgroundColor: '#0ea5e9' } }}
        initial={false}
