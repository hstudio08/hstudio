      ...
      <MagicContainer glowColor="166, 247, 208" spotlightRadius={500} className="max-w-[96rem] mx-auto px-4 sm:px-6 md:px-8">
        ...
        <ScrollReveal>
          <div className="text-center flex flex-col items-center space-y-2 md:space-y-3 mb-10 md:mb-16">
            ...
            <h2 id="projects-heading" className="text-3xl sm:text-4xl md:text-6xl font-black text-slate-900 font-['Foldit'] tracking-wide drop-shadow-sm px-2">
          ...
          <div id="services" className="mt-16 md:mt-32 bg-white rounded-[2rem] md:rounded-[2.5rem] border border-slate-100 p-5 sm:p-8 md:p-14 shadow-[0_10px_40px_rgba(0,0,0,0.02)] relative overflow-hidden">
                    ...
                    <div className="flex items-center space-x-3 md:space-x-5 mb-3 md:mb-5 relative z-10">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-1.5">
                          ...
                          <svg className="w-3.5 h-3.5 md:w-4 md:h-4 text-blue-500" fill="currentColor" viewBox="0 0 20 20" aria-label="Verified Client">
                      ...
                      <div className="text-yellow-400 text-xs md:text-sm hidden sm:flex tracking-widest drop-shadow-sm" aria-label="5 out of 5 stars">★★★★★</div>
                    </div>
            ...
            <div data-theme="dark" className="relative mt-10 md:mt-16 rounded-[2rem] overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.1)]">
              ...
              <div className="relative z-10 w-full h-full">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 p-6 sm:p-8 md:p-12 text-center">
                  {[
                    ...
                    <div 
                      key={i} 
                      className="glass-card flex flex-col items-center justify-center p-6 sm:p-8 transition-transform duration-500 hover:-translate-y-1 md:hover:-translate-y-2 group cursor-default w-full max-w-[240px] aspect-[2/3] mx-auto"
                    >
                      ...
                      <span className="text-xs md:text-sm text-[#0b1c30] font-bold uppercase tracking-wider mt-2 md:mt-4 font-['Familjen_Grotesk'] group-hover:text-[#0058bc] transition-colors duration-500 drop-shadow-sm text-center">{metric.label}</span>
                    </div>
                  ))}
                </div>
              </div>
